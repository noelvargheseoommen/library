...
echo '<script>alert("Publication list updated succesfully!")</script>';
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0" style="font-size: 30.752px;">Add Author</h3>
                    </div>
                </div>
                <div class="container">
                    <form class="user" role="form" method="post">
                        <div class="mb-3"></div>
                        <div class="mb-3"><input class="form-control form-control-user" type="text" name="author" placeholder="Author name"></div>
                        <div class="mb-3"></div><button class="btn btn-primary d-block btn-user w-100" name="create" type="submit">Add Author</button>
                        <hr>
                        <hr>
                    </form>
                </div>
